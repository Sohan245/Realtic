...
class Realtic(QWidget):
    ...
    def toolChanged(self):
        ...
        elif self.toolSelector.currentText() == 'BreakOTS':
        ...
        elif self.toolSelector.currentText() == 'RsaCtfTool':
            self.fileLabel.setText('Select PUB files for RsaCtfTool:')
    ...
    def runTool(self):
        ...
        elif self.toolSelector.currentText() == 'BreakOTS' and self.filePath:
